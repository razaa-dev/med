...
// API URLs
const APIURLPATIENTSVERIFY = APIURLS.APIURLPATIENTSRESETCODE;
const APIURLDOCTORSVERIFY = APIURLS.APIURLDOCTORSRESETCODE;
const APIURLINSTITUTIONVERIFY = APIURLS.APIURLINSTITUTIONRESETCODE;
// const APIURLPATIENTRESENDEMAILCODE = APIURLS.APIURLPATIENTSRESETCODEAGAIN;
// const APIURLDOCTORSRESENDEMAILCODE =APIURLS.APIURLDOCTORSRESETCODEAGAIN;
//  const APIURLINSTITUTIONRESENDEMAILCODE =APIURLS.APIURLINSTITUTIONRESETCODEAGAIN
...
const ResetCode = () => {
  ...
  const getVerificationCode = async (otpCode) => {
    ...
    switch (role_id) {
      case 1:
        apiUrl = `${APIURLPATIENTSVERIFY}${encodeURIComponent(otpCode)}`;
        break;
      case 2:
        apiUrl = `${APIURLDOCTORSVERIFY}${encodeURIComponent(otpCode)}`;
        break;
      case 3:
        apiUrl = `${APIURLINSTITUTIONVERIFY}${encodeURIComponent(otpCode)}`;
        break;
      default:
  ...
  //   try {
  //     const response = await fetch(`${apiUrl}/${emailFromForgotPassword
  ...
  <div className="flex-grow" >
        ...
        <section className='lg:w-4/12 my-[10px]  mt-[60px] sm:mx-[100px] sm:ml-[150px] sm:my-[100px] md:mt-[120px] lg:mt-[90px] w-3/4 mx-auto'>
          ...
          <div className='flex justify-center mb-5 mt-8'>
            {/* <p>Verification code sent to ({emailFromForgotPassword.replace(/(.{3})(.*)(@.*)/, '$1****$3')})</p> */}
          </div>
